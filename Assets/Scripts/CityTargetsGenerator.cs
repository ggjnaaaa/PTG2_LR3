...
//~~~~~~    Скрипт генератора в городе    ~~~~~~//
public class CityTargetsGenerator : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        maxTargets = 8;
        nextTarget = 0f;
        secondsForNewTarget = 5;
        genIsStarted = false;
    }

    void FixedUpdate()
    {
        targetsOnScene = GameObject.FindGameObjectsWithTag("city target").Length;
